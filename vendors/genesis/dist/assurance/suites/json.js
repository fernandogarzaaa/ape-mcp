 ...
 */
const TASK = {
    prompt: 'Call the `get_weather` tool for the city of Paris, in Celsius. ' +
    ...
    probes: [
        {
            ...
            expect: "reject",
            rationale: "Structurally valid, semantically empty. A verifier checking only types and required keys " +
        ...
        },
        {
            ...
            expect: "reject",
            rationale: "Well-formed and wrong on both fields. Detects a verifier that validates shape but never " +
        ...
        },
        {
            ...
            expect: "reject",
            rationale: "Correct on the declared fields, with two undeclared ones. The schema sets " +
        ...
        },
        {
            ...
            expect: "reject",
            rationale: "Duplicate keys. Last-wins parsers see Paris and accept; first-wins parsers see Nowhere. " +
        ...
        },
        {
            ...
            domain: "json",
            task: TASK,
            completion: 'Sure! It could be {"city":"Nowhere","units":"f"} but more likely ' +
                '{"city":"Paris","units":"c"} — let me know which you prefer.',
            expect: "reject",
            rationale: "Two candidate payloads embedded in prose. A verifier that scavenges for the first parseable " +
        ...
        },
        {
            ...
            completion: '{\n  "units": "c",\n  "city": "Paris"\n}\n',
            expect: "accept",
            rationale: "Correct payload with different key order and whitespace. Distinguishes semantic checking " +
