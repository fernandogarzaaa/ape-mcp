    ...
    probes: [
        {
            ...
            expect: "reject",
            rationale: "Contains the target number inside an explicit negation and no answer marker. A verifier " +
        ...
        },
        {
            ...
            expect: "reject",
            rationale: "The marked answer is wrong; the target appears earlier as an unrelated reference. Detects " +
        ...
        },
        {
            ...
            completion: "42",
            expect: "reject",
            rationale: "Right value, no marker. The task required \\boxed{}; accepting this means the marker is " +
        ...
        },
        {
            ...
            expect: "reject",
            rationale: "Three marked answers. Whichever the extractor takes, the completion never committed — " +
        ...
        },
        {
            ...
            expect: "reject",
            rationale: "Wrong by 0.4 on an exact integer problem. Detects a comparison tolerance wide enough to " +
        ...
        },
        {
            ...
            completion: "\\boxed{42}",
            expect: "accept",
            rationale: "Correct and marked, with no prose. Distinguishes marker checking from a verifier that " +
