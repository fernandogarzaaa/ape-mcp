    ...
    probes: [
        {
            ...
            expect: "reject",
            rationale: 'The app is named "Acme Notes." A correct oracle does not mark ' +
        ...
        },
        {
            ...
            expect: "reject",
            rationale: 'The dashboard shows a button labeled "Export all," reachable within a ' +
        ...
        // ── control ──
        {
            ...
            expect: "accept",
            rationale: 'The text "download" appears only on the export screen, reached by ' +
