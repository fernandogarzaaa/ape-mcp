...
export function cohenKappa(a, b) {
    ...
    if (pairs.length === 0)
        return { kappa: null, n: 0, interpretation: null };
    ...
    if (chance >= 1)
        return { kappa: null, n: pairs.length, interpretation: null };
...
export function fleissKappa(table) {
    ...
    agree /= items;
    if (1 - chance === 0)
        return { kappa: null, n: items, interpretation: null };
    const kappa = (agree - chance) / (1 - chance);
