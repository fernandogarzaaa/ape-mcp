        ...
        try {
            ...
            return {
                text: timedOut
                    ...
                    : `The assistant could not be reached: ${error instanceof Error ? error.message : String(error)}`,
                latencyMs,
                refused: true,
                ended: !timedOut,
            };
...
export function extractReply(raw, replyPath) {
    let parsed;
    try {
...
function withMessageQuery(url, message) {
    try {
