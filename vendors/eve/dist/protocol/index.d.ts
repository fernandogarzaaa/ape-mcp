 ...
 * ```
 */
export { CanonicalError, type CanonicalValue, compareUtf8, contentHash, fromBasisPoints, isTimestamp, seal, sha256Hex, timestamp, toBasisPoints, toCanonical, toSignedBasisPoints, verifySeal, } from "./canonical.js";
export { type ConformanceFailure, checkCorpus, checkManifest, describeFailures, isEventKind, } from "./conformance.js";
export { event, experienceFrom, observationFrom, provenance } from "./documents.js";
export { ENVELOPE_SCHEMA, EnvelopeError, type EnvelopeFailure, fromLine, openEnvelope, type SignedEnvelope, sealEnvelope, toLine, } from "./envelope.js";
export { type Component, type CpEvent, EVENT_EMITTER, EVENT_KINDS, type EventKind, EXPERIENCE_ACTIONS, type Experience, type ExperienceAction, type ExperienceOutcome, type FitnessResult, type Measurement, type Mutation, type MutationKind, type MutationStatus, type Observation, type PayloadValue, type PerceivedAffordance, type Provenance, type Recommendation, SUBJECT_TYPES, type SubjectType, type Surface, type ValidationRequest, } from "./types.js";
export { actionVerbRegistry, registerActionVerb } from "./verbs.js";
/** The revision of the normative source this binding implements. */
export declare const CP1_VERSION = "1.1.0";
/** The protocol identifier carried by every CP/1 document. */
export declare const CP: "cp1";
