 ...
 * `Experience`.
 */
export declare const EXPERIENCE_ACTIONS: readonly ["click", "type", "press", "scroll", "navigate", "back", "read", "wait", "abandon"];
...
export type MutationKind = "amend_genome" | "retire_skill" | "reconcile_belief" | "investigate_conflict";
...
export declare const EVENT_KINDS: readonly ["ObservationRecorded", "ExperienceCreated", "ContextCompressed", "GroundingFailed", "MemoryConsolidated", "BeliefUpdated", "SkillLearned", "ReflectionCompleted", "MutationProposed", "SimulationCompleted", "TaskRunCompleted", "FitnessMeasured", "MutationAccepted", "MutationRejected", "GenomeCommitted"];
export type EventKind = (typeof EVENT_KINDS)[number];
export declare const SUBJECT_TYPES: readonly ["Identity", "Genome", "Capability", "Belief", "Memory", "Skill", "Mutation", "Reflection", "Observation", "Experience", "FitnessResult", "Context"];
...
export declare function isPayloadValue(value: unknown): value is PayloadValue;
/** One announced fact. */
 ...
 */
export declare const EVENT_EMITTER: Readonly<Record<EventKind, readonly Component[]>>;
