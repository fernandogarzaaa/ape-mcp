...
export type ArtifactFormat = "markdown" | "html" | "slides" | "json" | "yaml" | "csv" | "transcript" | "text";
/**
...
export type BlockKind = "title" | "heading" | "paragraph" | "list-item" | "quote" | "code" | "table" | "figure" | "metric" | "caption" | "callout" | "reference" | "field" | "command" | "output" | "error" | "separator";
...
export declare function sectionNounFor(genre: ArtifactGenre): SectionNoun;
...
export declare function artifactWordCount(artifact: Artifact): number;
