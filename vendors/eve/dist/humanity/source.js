...
export function docTargetOf(target) {
 ...
 */
export async function loadArtifact(target, options = {}) {
...
export function artifactFromText(address, text, options = {}) {
    return readArtifactText({
        address,
        text,
...
async function fetchSource(address, timeoutMs) {
    if (address === "-")
        return { text: await readStdin(), extension: null };
