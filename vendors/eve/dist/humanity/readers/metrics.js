...
const QUANTITY = /^([+-]?[$£€¥]?\s?\d[\d,_]*(?:\.\d+)?)\s*(%|[KkMmBbTt]\b|ms\b|s\b|min\b|hrs?\b|days?\b|MB\b|GB\b|TB\b|req\/s\b|rps\b|USD\b|EUR\b|GBP\b)?/;
/**
 ...
 */
const BASELINE = /\b(?:vs\.?|versus|compared with|compared to|up from|down from|from)\s+[^,;)]+|(?:\b(?:QoQ|YoY|MoM|WoW|DoD)\b)|(?:[+-]\s?\d+(?:\.\d+)?\s?%)/i;
/**
