...
export function detectHtml(input) {
    if (input.extension === ".html" || input.extension === ".htm")
        return 0.95;
...
export function readHtml(input) {
    ...
    while (match !== null) {
        ...
        if (name === "img" && !closing) {
            ...
            if (!closing) {
                ...
                const detail = { columns: table.columns, rows: table.rows };
