 ...
 */
export declare const LEGACY_WEB_VERBS: readonly ["click", "doubleClick", "hover", "type", "press", "scroll", "navigate", "back", "read", "wait", "abandon"];
/** The verbs a surface actuates natively (declared, or the legacy web set). */
export declare function actionVerbsFor(capabilities: SurfaceCapabilities): readonly string[];
/** A rendered browser page: full pixel geometry and styling, driven by a mouse. */
export declare const VISUAL_SURFACE: SurfaceCapabilities;
/**
 ...
 */
export declare const TEXTUAL_SURFACE: SurfaceCapabilities;
/**
 ...
 */
export declare const TOUCH_VISUAL_SURFACE: SurfaceCapabilities;
/**
 ...
 * point at.
 */
export declare const DOCUMENT_SURFACE: SurfaceCapabilities;
/**
 ...
 */
export declare const DOCUMENT_VERBS: readonly ["doc.skim", "doc.read", "doc.study", "doc.next", "doc.back", "doc.reread", "doc.follow", "read", "wait"];
/**
 ...
 */
export declare const CONVERSATIONAL_SURFACE: SurfaceCapabilities;
/**
 ...
 * ask for a human.
 */
export declare const CONVERSATION_VERBS: readonly ["chat.say", "chat.followup", "chat.rephrase", "chat.clarify", "chat.escalate", "read", "wait"];
