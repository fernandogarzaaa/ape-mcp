...
export declare function resolveNativeDialogHandling(action: AdapterOptions["nativeDialogAction"]): NativeDialogHandling;
export declare function recordNativeDialog(pending: PendingNativeDialog[], message: string, action: AdapterOptions["nativeDialogAction"]): NativeDialogHandling;
/** Surface pending native dialogs on a snapshot (clears the queue). */
export declare function mergeNativeDialogs(dialogs: Percept["dialogs"], pending: PendingNativeDialog[]): Percept["dialogs"];
