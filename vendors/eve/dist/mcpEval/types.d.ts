...
export declare const MCP_FINDING_CATEGORIES: readonly ["mcp.schema-quality", "mcp.robustness", "mcp.conformance"];
...
export declare const MCP_DIMENSIONS: readonly ["mcp.schemaQuality", "mcp.robustness", "mcp.conformance"];
export type McpDimension = (typeof MCP_DIMENSIONS)[number];
/** Finding category ↔ score dimension correspondence. */
export declare const DIMENSION_FOR_CATEGORY: Record<McpFindingCategory, McpDimension>;
