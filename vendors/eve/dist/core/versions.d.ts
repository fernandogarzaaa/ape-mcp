 ...
 */
export declare const BEHAVIOR_MODEL_VERSION = "1.0.0";
export declare const PARAMETER_SET_VERSION = "1.0.0";
/**
 ...
 */
export declare const ADAPTER_VERSION = "0.5.0";
/**
 ...
 */
export declare function implementationRevision(): string | null;
