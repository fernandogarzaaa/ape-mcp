 ...
 */
export type EvidenceProvenance = "observed" | "derived" | "heuristic" | "model-inferred" | "llm-inferred" | "human-calibrated" | "externally-validated" | "modeled";
 ...
 */
export type PerceptSnapshot = Omit<Percept, "screenshot"> & {
