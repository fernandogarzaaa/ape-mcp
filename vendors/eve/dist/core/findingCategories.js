 ...
 */
import { ALL_MODALITIES, EveRegistry } from "./registry.js";
import { FINDING_CATEGORIES } from "./types.js";
const VISUAL_ONLY = ["visual"];
const BUILT_INS = [
...
export const findingCategoryRegistry = new EveRegistry("finding category");
for (const entry of BUILT_INS)
    findingCategoryRegistry.register(entry);
...
export function registerFindingCategory(entry) {
...
//# sourceMappingURL=findingCategories.js.map