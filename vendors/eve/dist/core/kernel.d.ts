...
export type AffordanceLocator = {
    ...
    readonly kind: "charCell";
    readonly line: number;
    readonly column: number;
} | {
    readonly kind: "schemaPath";
 ...
 */
 | {
    readonly type: "surface-terminated";
 ...
 */
export type KernelPercept = VisualKernelPercept | TextualKernelPercept | DocumentKernelPercept | ConversationalKernelPercept;
/**
 ...
 */
export declare function surfaceAuthoredText(kernel: KernelPercept): string;
/**
 ...
 */
export declare function kernelFromWebPercept(percept: Percept, modality?: Modality): KernelPercept;
/**
 ...
 */
export declare function webPerceptFromVisualKernel(percept: VisualKernelPercept): Percept;
