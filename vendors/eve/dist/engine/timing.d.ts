 ...
 */
export declare function computePerceivedLatency(opts: {
...
export declare const TIMING_SEMANTICS = "Perceived surface latency starts at actuation completion; human decision/hesitation/motor time is excluded; settle is counted exactly once via the clock.";
/**
 ...
 */
export declare function latencyEvidenceFor(opts: {
    modeledMs: number;
    observedMs: number;
