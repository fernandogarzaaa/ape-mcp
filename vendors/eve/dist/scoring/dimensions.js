 ...
 */
import { ALL_MODALITIES, EveRegistry, } from "../core/registry.js";
...
export const dimensionRegistry = new EveRegistry("score dimension");
for (const entry of BUILT_INS)
    dimensionRegistry.register(entry);
 ...
 */
export function registerDimension(entry) {
...
export function dimensionsFor(modality) {
